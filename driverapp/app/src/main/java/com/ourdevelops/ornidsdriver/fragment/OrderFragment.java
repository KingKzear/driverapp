...
public class OrderFragment extends Fragment implements OnMapReadyCallback, OnCameraTrackingChangedListener {
                ...
                if (responsedata.isSuccessful()) {
                    ...
                    if (onsubmit.equals("2")) {
                        ...
                        if (transaksi.getHome().equals("4")) {
                            layanandesk.setText(getString(R.string.go_buy));
                            submit.setText(getString(R.string.deliver_order));
                            ...
                            public void onClick(View view) {
                                if (transaksi.getHome().equals("4")) {
                                    ...
                                    if (verify.getText().toString().isEmpty()) {
                                        Toast.makeText(context, getString(R.string.enter_verify_code), Toast.LENGTH_SHORT).show();
                                    } else {
                        ...
                        if (transaksi.getHome().equals("4")) {
                            layanandesk.setText(getString(R.string.deliver_order));
                        } else {
                    ...
                    if (transaksi.getHome().equals("3")) {
                        ...
                        phonemerchant.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                alertDialogBuilder.setTitle(getString(R.string.call_merchant));
                        ...
                        senderphone.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context, R.style.DialogStyle);
                                alertDialogBuilder.setTitle(getString(R.string.call_sender));
                                alertDialogBuilder.setMessage( getString(R.string.want_to_call) + transaksi.getNamaPengirim() + "(" + transaksi.teleponPengirim + ")?");
                                alertDialogBuilder.setPositiveButton(getString(R.string.yes),
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        receiverphone.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context, R.style.DialogStyle);
                                alertDialogBuilder.setTitle(getString(R.string.call_receiver));
                                alertDialogBuilder.setMessage(getString(R.string.want_to_call) + transaksi.getNamaPenerima() + "(" + transaksi.teleponPenerima + ")?");
                                alertDialogBuilder.setPositiveButton(getString(R.string.yes),
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface arg0, int arg1) {
    ...
    private void parsedata(TransModel request, final CustomerModel pelanggan) {
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context, R.style.DialogStyle);
                alertDialogBuilder.setTitle(getString(R.string.call_customer));
                ...
                if (response.isSuccessful()) {
                    ...
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("berhasil")) {
                        ...
                        if (type.equals("4")) {
                            ...
                            orderfcm.desc = getString(R.string.deliver_order_desc);
                        ...
                        startActivity(i);
                        Toast.makeText(context, getString(R.string.order_unavailable), Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onResponse(@NonNull Call<ResponseJson> call, @NonNull final Response<ResponseJson> response) {
                if (response.isSuccessful()) {
                    ...
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                        ...
                        rlprogress.setVisibility(View.GONE);
                        Toast.makeText(context, getString(R.string.verify_incorrect), Toast.LENGTH_SHORT).show();
                    }
                }
            }

...
public class SettingPreference {
    ...
    public SettingPreference(HomeFragment homeFragment) {
    }
    ...
    public void updateDecimal(String string) {
        editor = pref.edit();
        editor.putString(DECIMAL, string);
        editor.commit();
    }
    ...
    public String[] getSetting() {
        ...
        String[] settingan = new String[23];
        ...
        settingan[22] = pref.getString(DECIMAL, "0");
        return settingan;
    }

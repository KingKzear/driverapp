...
import com.ourdevelops.ornidsdriver.utils.NetworkUtils;
...
public class LoginActivity extends AppCompatActivity {
    ...
    EditText phoneText, password, numOne, numTwo, numThree, numFour, numFive, numSix, balance, currency;
...
//        password.setText("123456789");
    ...
    public void verifyCode(View view) {
        ...
        if (!code.equals("")) {
            ...
            notif2(getString(R.string.empty_verify_code));
        }
    ...
    private void onSignInClick(String check) {
        progressshow();
        ...
        service.login(request).enqueue(new Callback<LoginResponseJson>() {
            ...
            public void onResponse(@NonNull Call<LoginResponseJson> call, @NonNull Response<LoginResponseJson> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("next")) {
                    ...
                    } else if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("found")) {
                        User user = response.body().getData().get(0);
                        saveUser(user);
                        SettingPreference sp = new SettingPreference(LoginActivity.this);
                        ...
                        sp.updatecurrencytext(response.body().getCurrency_text());
                        sp.updateStripepublish(response.body().getStripePublish());
                        sp.updateDecimal(response.body().getDecimal());

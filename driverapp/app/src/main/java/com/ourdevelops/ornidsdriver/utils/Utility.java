...
public class Utility {
    ...
    public static void currencyTXT(TextView text, String nomninal, Context context) {
        ...
        if (sp.getSetting()[22].equals("2")) {
            ...
            } else if (nomninal.length() == 2 && nomninal.substring(0, 1).equals("-")) {
                text.setText(sp.getSetting()[4] + "-0.0" + nomninal.replace("-", ""));
            } else if (nomninal.length() == 2) {
                text.setText(sp.getSetting()[4] + "0." + nomninal);
            } else if (nomninal.length() == 3 && nomninal.substring(0, 1).equals("-")) {
                text.setText(sp.getSetting()[4] + "-0." + nomninal.replace("-", ""));
            } else {
            ...
            Double getprice = Double.valueOf(nomninal);
            DecimalFormat formatter = new DecimalFormat("#,###");
            String formattedString = formatter.format(getprice/100);
            text.setText(sp.getSetting()[4] + formattedString.replace(",", "."));
        }
    }

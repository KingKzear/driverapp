...
public interface DriverService {
    ...
    @POST("driver/tokengenerator")
    Call<TokenResponseJson> tokengenerator(@Body LoginRequestJson param);

    @POST("driver/sendpin")
    Call<PincodeResponseJson> testPin(@Body PincodeRequestJson param);
}

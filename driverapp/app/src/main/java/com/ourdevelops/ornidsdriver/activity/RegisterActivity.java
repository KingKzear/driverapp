    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == 2) {
                ...
                Bitmap scaleBitmap = Bitmap.createScaledBitmap(imagebitmap, (int) (imagebitmap.getWidth() * 0.5), (int) (imagebitmap.getHeight()*0.5) ,  true);
...
//sendcode-----------------------
    ...
    private void setUpVerificatonCallbacks() {
        verificationCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                notif2(getString(R.string.failed_verification));
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    notif2(getString(R.string.wrong_code));
                } else if (e instanceof FirebaseTooManyRequestsException) {
                    notif2(getString(R.string.excess_request));
                    notif(getString(R.string.excess_request));
                }
            }
    ...
    public void verifyCode(View view) {
        ...
        if (!code.equals("")) {
            ...
            notif2(getString(R.string.enter_verify_code));
        }
